    ...
    const sfx = {
      ...
      tournamentComplete() {
        ...
        [523, 659, 784, 1047, 1319].forEach((f, i) => {
          const delay = i * 0.09;
          osc("sine",     f,     t + delay,        0.45, 0.22);
          osc("triangle", f * 2, t + delay + 0.01, 0.35, 0.18);
        });
        // Final chord
        [523, 659, 784].forEach(f => osc("sine", f, t + 0.55, 0.6, 0.25));
        // Coin explosion
        [400, 480, 560, 640, 700].forEach(ms => setTimeout(() => sfx.chip(), ms));
      },
    };
